...
namespace SA.Identity.API.Services
{
    public class AuthenticationService
    {
        ...
        public async Task<UserResponseLogin> GerarJwt(string email)
        {
        ...
        private UserResponseLogin ObterRespostaToken(string encodedToken, IdentityUser user,
